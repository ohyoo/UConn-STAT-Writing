...
This book, *Advanced Research Writing in Statistics and Data Science*, extends earlier efforts with [*Statistical Writing*](https://statds.github.io/stat-writing/) by broadening its scope and including examples/exercises.   
...
2. **Adaptive**: tailoring style and structure to journals, conferences, and other outlets.  
...
You can view an example of a marked-up draft with comments from my PhD advisor here:  
